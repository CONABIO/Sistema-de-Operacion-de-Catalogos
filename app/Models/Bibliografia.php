...
class Bibliografia extends Model
{
  ...
  public function gruposScat()
  {
    // Nombre del modelo relacionado, nombre de la tabla pivote, y las claves foráneas
    return $this->belongsToMany(GrupoScat::class, 'RelBiblioGrupoSCAT', 'IdBibliografia', 'IdGrupoSCAT');
  }
}
