...
<template>
  <el-tooltip class="item" effect="dark" content="Características">
  <el-button 
    color="#7327F5"
    circle 
    :disabled="disabled" 
