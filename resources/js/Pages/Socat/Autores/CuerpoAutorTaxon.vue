                    ...
                    <el-collapse v-model="activeNames">
                        <el-collapse-item title="Autores Relacionados" name="1">
                            <el-scrollbar max-height="400px">
                                ...
                                margin-bottom: 10px;">
                                    ...
                                    <div>
                                        <el-tooltip effect="dark" content="Subir" placement="bottom">
                                            <el-button circle type="warning" :disabled="!filaSeleccionada"
                                                @click="subirRow()" color="#60A3A3">
                                ...
                                <el-table ref="tablaAutores" :data="autoresRel" class="tabla-autores-personalizada"
                                    style="width: 100%" max-height="250" :show-header="false" highlight-current-row
                                    @current-change="onRowChange">
                                    <el-table-column prop="IdAutorTaxon" label="Id" width="80" v-if="false" />
                                    <el-table-column label="Texto Inicio" width="120">
                                        <template #default="scope"><el-input v-model="scope.row.CadInicio"
                                                placeholder="Texto" maxlength="15"
                                                @input="val => handleInput(val, scope, 'CadInicio')" /></template>
                                    </el-table-column>
                                    <el-table-column prop="NombreAutoridad" label="Nombre" min-width="180" />
                                    <el-table-column label="Texto Final" width="300">
                                        <template #default="scope"><el-input v-model="scope.row.CadFinal"
                                                placeholder="Texto" maxlength="15"
                                                @input="val => handleInput(val, scope, 'CadFinal')"
