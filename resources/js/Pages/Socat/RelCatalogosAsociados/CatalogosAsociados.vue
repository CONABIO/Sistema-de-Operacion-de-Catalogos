                                            ...
                                            <el-splitter-panel :size="'40%'">
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <el-input v-model="observacionesGeneral" type="textarea" :rows="2"
                                                            :placeholder="placeholderObservaciones" style="font-size: 12px;"
                                                            :disabled="!editandoObsGeneral" />
                                                    </div>
                                                </div>
                                            </el-splitter-panel>
                                                        ...
                                                        <div class="table-wrapper"
                                                            ...
                                                            <div style="flex: 1; padding: 10px; overflow: auto;">
                                                                <TablaFiltrable :columnas="columnasDefinidasCaract"
                                                                    ...
                                                                    @nuevo-item="nuevoRelCaract" @editar-item="editarCarct"
                        ...
                        <el-splitter style="height: 100%; border: 1px solid #ddd; border-radius: 8px;">
                            <el-splitter-panel :min="20" :size="'25%'">
                                <div class="table-wrapper"
                                    ...
                                    <div style="flex: 1; padding: 10px; overflow: auto;">
                                        <TablaFiltrable :columnas="columnasDefinidasModal" ref="refTablaNomComunModal"  :datos="tablaNomComunAsociados" :permitirSinSeleccion="true"
                                            :totalItems="totalRegNomComun" :alturaTabla="500" :highlight-current-row="true" row-key="IdNomComun"
                                        ...
                                        <div class="table-wrapper"
                                            ...
                                            <div style="flex: 1; padding: 10px; overflow: auto;">
                                                <TablaFiltrable :columnas="columnasDefinidasRegNomCom"
                                                    ref="refTablaRegionesModal"  :datos="tablaNomComunReg" :totalItems="totalRegionNomComun" :permitirSinSeleccion="true"
                                                    :alturaTabla="500" :highlight-current-row="true" :mostrarBiblio="false"  row-key="IdRegion"
                                                ...
                                                <div class="table-wrapper"
                                                    ...
                                                    <div style="flex: 1; padding: 10px; overflow: auto;">
                                                        <TablaFiltrable :columnas="colDefBiblioFinal"
                                                            ref="refTablaBiblioModal"
                                                            row-key="IdBibliografia"
...
import EliminarButton from '@/Components/Biotica/EliminarButton.vue';
  ...
  const abrirResumenRegiones = () => {
    ...
    setTimeout(() => {
        ...
        tablas.forEach(t => {
            if (t.value && t.value.$refs.tableRef) {
                t.value.$refs.tableRef.setCurrentRow(null);
            }
        });
    }, 200);
};
    ...
    const activarEdicionGeneral = () => {
        if (!idNomComunSeleccionado.value) {
            mostrarNotificacion("Aviso", "Por favor seleccione un nombre de la lista para editar", "warning");
            return;
        }
        editandoObsGeneral.value = true;
    };
