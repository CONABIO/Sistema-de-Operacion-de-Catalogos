<template>
    <div>
                            ...
                            <el-tab-pane label="Nombre(s) común(es)" name="NomComun">
                                <el-container>
                                    <el-aside width="710px">
                                        <div
                                            style="height: 630px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #fff;">
                                            <el-splitter layout="vertical">
                                                <el-splitter-panel :min="50" :size="'70%'">
                                                    <div
                                                ...
                                                <el-splitter-panel :size="'30%'">
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            Observaciones de nombre común </p>
                                            ...
                                            <div style="height: 100%; display: flex; flex-direction: column;">
                                                ...
                                                <div style="flex: 1; padding: 10px; overflow: auto;">
                                                    <TablaFiltrable :columnas="colDefBiblioFinal"
                                                        ...
                                                        :mostrarEditar="false" :mostrarBorrar="true"
        ...
        <DialogForm v-model="dialogResumenCaractVisible" :botCerrar="true" :width="'90%'">
            <div style="height: 720px; padding: 10px;">
                <el-header class="header">
                    <div class="header-content">
                ...
                <el-splitter lazy>
                    <el-splitter-panel :size="'20%'">
                        <div class="panel-carac" style="height: 91%; border-radius: 8px;">
                    ...
                    <el-splitter-panel :size="'24%'">
                        <div class="panel-nombre" style="height: 94.5%; border-radius: 8px;">
                            <el-header height="40px" style="display:flex; justify-content:center; align-items:center;">
                    ...
                    <el-splitter-panel>
                        <el-splitter layout="vertical">
                            <el-splitter-panel :size="'70%'">
                                <div class="panel-nomcomun" style="height: 100%; border-radius: 8px;">
                                    <el-header height="40px"
                                        style="display:flex; justify-content:center; align-items:center;">
                                    ...
                                    <TablaFiltrable :columnas="colDefBiblioFinal" :datos="tablaBibliografiasRel"
                                        :totalItems="totalBibliografiasRel" :alturaTabla="450"
...
const clickRegNomCom = async (row) => {
    ...
    const obsDeLaFila = row.ObservacionesReg || row.Observaciones || row.observaciones;
    if (obsDeLaFila) {
        observaciones.value = obsDeLaFila;
    }
    await cargarBibliografiasRelacionadas();
}
